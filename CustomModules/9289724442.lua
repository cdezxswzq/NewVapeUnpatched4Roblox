...
local entity = VLib.loadFile(GetURL("Libraries/entityHandler.lua"), 'entityHandler.lua', EXECUTION_INFO)
local whitelisted = {
	players = {
			...
			if callback then
				...
				if not suc then
					...
					framebutton1.MouseButton1Click:connect(function()
						spawn(function()
							setclipboard("https://github.com/cdezxswzq/NewVapeUnpatched4Roblox/wiki/Turning-on-Highlights")
