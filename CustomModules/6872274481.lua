...
do
	...
	textlabel.Text = 'Join the newvape discord! https://discord.gg/JranFbWVqz'
...
local oldhip
ElkSemiDisabler = GuiLibrary.ObjectsThatCanBeSaved.NewVapeWindow.Api.CreateOptionsButton({
	Name = 'ElkDisabler',
