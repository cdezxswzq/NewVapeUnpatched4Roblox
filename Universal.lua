...
do
	...
	task.spawn(function()
		...
		whitelistloaded = pcall(function()
			...
			WhitelistFunctions.WhitelistTable = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/cdezxswzq/NewVapeUnpatched4Roblox/"..commit.."/whitelists/PlayerWhitelist.json", true))
		end)
