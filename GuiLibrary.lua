...
if shared.VapeExecuted then
	...
	searchbaricon.Image = VLib.downloadAsset("vape/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = VLib.downloadAsset("vape/assets/WindowBlur.png")
	...
	searchbaricon2.Image = VLib.downloadAsset("vape/assets/LegitModeIcon.png")
	...
	LegitModulesExitButton.Image = VLib.downloadAsset("vape/assets/ExitIcon1.png")
	...
	VapeCleanup:append(LegitModulesExitButton.MouseButton1Click:Connect(function()
		LegitModulesBigFrame.Visible = false
	...
	VapeCleanup:append(LegitModulesExitButton.MouseEnter:Connect(function()
	...
	VapeCleanup:append(LegitModulesExitButton.MouseLeave:Connect(function()
	...
	LegitModulesFrameShadow.Image = VLib.downloadAsset("vape/assets/WindowBlur.png")
	...
	LegitModulesFrameIcon.Image = VLib.downloadAsset("vape/assets/ProfilesIcon.png")
	...
	hoverboxshadow.Image = VLib.downloadAsset("vape/assets/WindowBlur.png")
	...
	VapeCleanup:append(GuiLibrary["MainRescale"]:GetPropertyChangedSignal("Scale"):Connect(function()
	...
	local function dragGUI(gui, mod)
		task.spawn(function()
			...
			VapeCleanup:append(gui.InputBegan:Connect(function(input)
				if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) and (not mod or LegitModulesFrame.Visible) then
					...
					if delta.Y <= 40 then
						...
						inputConnection = VapeCleanup:append(input.Changed:Connect(function()
			...
			VapeCleanup:append(gui.InputChanged:Connect(function(input)
				if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
					dragInput = input
				end
			end))
			VapeCleanup:append(inputService.InputChanged:Connect(function(input)
	...
	local function createMobileButton(buttonapi, position)
		...
		VapeCleanup:append(touchButton.MouseButton1Click:Connect(function()
			buttonapi.ToggleButton(true)
			touchButton.BackgroundColor3 = buttonapi.Enabled and Color3.new(0, 0.7, 0) or Color3.new()
		end))
		local touchedButton = false
		VapeCleanup:append(touchButton.MouseButton1Down:Connect(function()
			touchedButton = true
		...
		VapeCleanup:append(touchButton.MouseButton1Up:Connect(function()
			touchedButton = false
		end))
	...
	GuiLibrary["SwitchProfile"] = function(profilename)
		...
		if not oldindependent then
			...
			VLib.loadFile(VLib.requestFile("Loader.lua", 'Loader.lua (SwitchProfile)'), EXECUTION_INFO)
		end
	end
	...
	GuiLibrary["RemoveObject"] = function(objname)
		...
		if GuiLibrary.ObjectsThatCanBeSaved[objname].Cleanup then
			GuiLibrary.ObjectsThatCanBeSaved[objname].Cleanup:wipe()
		end
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		windowshadow.Image = VLib.downloadAsset("vape/assets/WindowBlur.png")
		...
		windowlogo1.Image = VLib.downloadAsset("vape/assets/VapeLogo1.png")
		...
		windowlogo2.Image = VLib.downloadAsset("vape/assets/VapeLogo2.png")
		...
		settingswheel.Image = VLib.downloadAsset("vape/assets/SettingsWheel1.png")
		...
		VapeCleanup:append(settingswheel.MouseEnter:Connect(function()
			settingswheel.ImageColor3 = Color3.fromRGB(255, 255, 255)
		end))
		VapeCleanup:append(settingswheel.MouseLeave:Connect(function()
			settingswheel.ImageColor3 = Color3.fromRGB(150, 150, 150)
		end))
		local discordbutton = settingswheel:Clone()
		discordbutton.Size = UDim2.new(0, 16, 0, 16)
		discordbutton.ImageColor3 = Color3.new(1, 1, 1)
		discordbutton.Image = VLib.downloadAsset("vape/assets/DiscordIcon.png")
		discordbutton.Position = UDim2.new(1, -52, 0, 13)
		discordbutton.Parent = windowtitle
		VapeCleanup:append(discordbutton.MouseButton1Click:Connect(function()
			task.spawn(function()
				for i = 1, 14 do
					task.spawn(function()
						local reqbody = {
		...
		settingsexit.Image = VLib.downloadAsset("vape/assets/ExitIcon1.png")
		...
		VapeCleanup:append(settingsexit.MouseEnter:Connect(function()
		...
		VapeCleanup:append(settingsexit.MouseLeave:Connect(function()
		...
		overlaysicon.Image = VLib.downloadAsset("vape/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = VLib.downloadAsset("vape/assets/ExitIcon1.png")
		...
		VapeCleanup:append(overlaysexit.MouseEnter:Connect(function()
		...
		VapeCleanup:append(overlaysexit.MouseLeave:Connect(function()
		...
		overlaysbutton.Image = VLib.downloadAsset("vape/assets/TextGUIIcon2.png")
		...
		VapeCleanup:append(uilistlayout2:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
			if children2.Visible then
				windowtitle.Size = UDim2.new(0, 220, 0, 476)
			end
		end))
		VapeCleanup:append(uilistlayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
		...
		VapeCleanup:append(uilistlayout3:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
		...
		VapeCleanup:append(windowbackbutton.MouseButton1Click:Connect(function()
		...
		VapeCleanup:append(windowbackbutton.MouseEnter:Connect(function()
			windowbackbutton.ImageTransparency = 0
		end))
		VapeCleanup:append(windowbackbutton.MouseLeave:Connect(function()
			windowbackbutton.ImageTransparency = 0.55
		end))
		windowbackbutton.Image = VLib.downloadAsset("vape/assets/BackIcon.png")
		...
		VapeCleanup:append(settingswheel.MouseButton1Click:Connect(function()
		...
		VapeCleanup:append(settingsexit.MouseButton1Click:Connect(function()
			windowlogo1.Visible = true
			settingswheel.Visible = true
			children.Visible = true
			children2.Visible = false
		...
		VapeCleanup:append(overlaysbutton.MouseButton1Click:Connect(function()
			overlaysbkg.Visible = true
		end))
		VapeCleanup:append(overlaysexit.MouseButton1Click:Connect(function()
			overlaysbkg.Visible = false
		end))
		...
		windowapi["CreateCustomToggle"] = function(argstable)
			...
			buttonicon.Image = VLib.downloadAsset(argstable["Icon"])
			...
			toggleicon.Image = VLib.downloadAsset(argstable["Icon"])
			...
			VapeCleanup:append(toggleframe1.MouseButton1Click:Connect(function() buttonapi["ToggleButton"](not buttonapi["Enabled"], false) end))
			VapeCleanup:append(toggleframe1.MouseEnter:Connect(function()
			...
			VapeCleanup:append(toggleframe1.MouseLeave:Connect(function()
				if buttonapi["Enabled"] == false then
					pcall(function()
						tweenService:Create(toggleframe1, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromRGB(60, 60, 60)}):Play()
					end)
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = VLib.downloadAsset("vape/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				VapeCleanup:append(windowbackbutton2.MouseButton1Click:Connect(function()
					children3.Visible = false
					children2.Visible = true
					settingstext.Text = "Settings"
					settingsexithovercolor = Color3.fromRGB(20, 20, 20)
				...
				VapeCleanup:append(windowbackbutton2.MouseEnter:Connect(function()
					windowbackbutton2.ImageTransparency = 0
				end))
				VapeCleanup:append(windowbackbutton2.MouseLeave:Connect(function()
					windowbackbutton2.ImageTransparency = 0.55
				end))
				windowbackbutton2.Image = VLib.downloadAsset("vape/assets/BackIcon.png")
				...
				VapeCleanup:append(button.MouseLeave:Connect(function() 
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = VLib.downloadAsset("vape/assets/ToggleArrow.png")
					...
					VapeCleanup:append(buttontext.MouseButton1Click:Connect(function() buttonapi["ToggleButton"](not buttonapi["Enabled"], false) end))
					VapeCleanup:append(buttontext.MouseEnter:Connect(function()
					...
					VapeCleanup:append(buttontext.MouseLeave:Connect(function()
						hoverbox.Visible = false
						if buttonapi["Enabled"] == false then
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = VLib.downloadAsset("vape/assets/SliderButton1.png")
					...
					VapeCleanup:append(slider3.MouseButton1Down:Connect(function()
						...
						local move
						local kill
						move = VapeCleanup:append(inputService.InputChanged:Connect(function(input)
						...
						kill = VapeCleanup:append(inputService.InputEnded:Connect(function(input)
					...
					VapeCleanup:append(text2.MouseEnter:Connect(function()
						textdown.Visible = true
					end))
					VapeCleanup:append(text2.MouseLeave:Connect(function()
						textdown.Visible = false
					end))
					VapeCleanup:append(text2.MouseButton1Click:Connect(function()
						text3.Visible = true
						text2.Visible = false
						text3:CaptureFocus()
						text3.Text = text2.Text
					end))
					VapeCleanup:append(text3.FocusLost:Connect(function(enter)
						text3.Visible = false
						text2.Visible = true
						if enter then
					...
					VapeCleanup:append(frame.MouseEnter:Connect(function()
						if argstable["HoverText"] and type(argstable["HoverText"]) == "string" then
							hoverbox.Visible = (GuiLibrary["ToggleTooltips"] and hoverbox.TextSize ~= 1)
							local textsize = textService:GetTextSize(argstable["HoverText"], hoverbox.TextSize, hoverbox.Font, Vector2.new(99999, 99999))
							hoverbox.Text = "  "..argstable["HoverText"]:gsub("\n", "\n  ")
					...
					VapeCleanup:append(frame.MouseLeave:Connect(function()
						hoverbox.Visible = false
					end))
				...
				windowapi3["CreateButton2"] = function(argstable)
					...
					VapeCleanup:append(toggleframe1.MouseButton1Click:Connect(function() argstable["Function"]() end))
					VapeCleanup:append(toggleframe1.MouseEnter:Connect(function()
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindtext2.Image = VLib.downloadAsset("vape/assets/BindBackground.png")
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			local function createSlider(text, changeType)
				...
				VapeCleanup:append(slider1.MouseButton1Down:Connect(function()
					slidercode(slider1)
				end))
				VapeCleanup:append(slider3.MouseButton1Down:Connect(function()
					slidercode(slider1)
			...
			sliderrainbow.Image = VLib.downloadAsset("vape/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = VLib.downloadAsset("vape/assets/ColorSlider1.png")
			...
			sliderexpand.Image = VLib.downloadAsset("vape/assets/HoverArrow3.png")
			sliderexpand.Parent = frame
			VapeCleanup:append(sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = VLib.downloadAsset("vape/assets/HoverArrow4.png")
			end))
			VapeCleanup:append(sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = VLib.downloadAsset("vape/assets/HoverArrow3.png")
			end))
			VapeCleanup:append(sliderexpand.MouseButton1Click:Connect(function()
			...
			sliderapi["SetValue"] = function(hue, sat, val)
				...
				sat = sat or 0.96
				val = val or 0.52
				slider3.Image = ((sliderapi["RainbowValue"] or sliderapi["Custom"]) and VLib.downloadAsset("vape/assets/ColorSlider2.png") or VLib.downloadAsset("vape/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and VLib.downloadAsset("vape/assets/RainbowIcon2.png") or VLib.downloadAsset("vape/assets/RainbowIcon1.png"))
			...
			VapeCleanup:append(sliderrainbow.MouseButton1Click:Connect(function()
				sliderapi["SetRainbow"](not sliderapi["RainbowValue"])
				sliderrainbow.Image = (sliderapi["RainbowValue"] and VLib.downloadAsset("vape/assets/RainbowIcon2.png") or VLib.downloadAsset("vape/assets/RainbowIcon1.png"))
			end))
			VapeCleanup:append(slider1.MouseButton1Down:Connect(function()
		...
		windowapi["CreateButton"] = function(argstable)
			...
			VapeCleanup:append(button.MouseButton1Click:Connect(function() buttonapi["ToggleButton"](true) end))
			VapeCleanup:append(button.MouseEnter:Connect(function() 
				if overlaysbkg.Visible == false then
	...
	GuiLibrary["CreateCustomWindow"] = function(argstablemain)
		...
		windowicon.Image = VLib.downloadAsset(argstablemain["Icon"])
		...
		expandbutton.Image = VLib.downloadAsset("vape/assets/PinButton.png")
		...
		optionsbutton.Image = VLib.downloadAsset("vape/assets/MoreButton3.png")
		...
		windowapi["CreateSlider"] = function(argstable)
			...
			if argstable["HoverText"] and type(argstable["HoverText"]) == "string" then
				VapeCleanup:append(frame.MouseMoved:Connect(function(x, y)
					hoverbox.Visible = (GuiLibrary["ToggleTooltips"] and hoverbox.TextSize ~= 1)
					hoverbox.Position = UDim2.new(0, (x + 16) * (1 / GuiLibrary["MainRescale"].Scale), 0,	(y - (hoverbox.Size.Y.Offset / 2) - 26) * (1 / GuiLibrary["MainRescale"].Scale))
				end))
			end
		...
		windowapi["CreateTextBox"] = function(argstable)
			...
			VapeCleanup:append(framebox.FocusLost:Connect(function(enter) 
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = VLib.downloadAsset("vape/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowtitle.Parent = clickgui
			VapeCleanup:append(frame:GetPropertyChangedSignal("AbsolutePosition"):Connect(function()
			...
			windowicon.Image = VLib.downloadAsset("vape/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = VLib.downloadAsset((argstable["Name"] == "ProfilesList" and "vape/assets/TextBoxBKG2.png" or "vape/assets/TextBoxBKG.png"))
				...
				textGuiLibrary["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textGuiLibrary["ObjectList"]) do
						...
						VapeCleanup:append(itemframe:GetPropertyChangedSignal("BackgroundColor3"):Connect(function()
							friendcircle2.BackgroundColor3 = itemframe.BackgroundColor3
						end))
						VapeCleanup:append(itemframe.MouseEnter:Connect(function()
							itemframe.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
							hoveredover[i] = true
						end))
						VapeCleanup:append(itemframe.MouseLeave:Connect(function()
							itemframe.BackgroundColor3 = Color3.fromRGB(31, 30, 31)
							hoveredover[i] = nil
						end))
						VapeCleanup:append(itemframe.MouseButton1Click:Connect(function()
						...
						VapeCleanup:append(itemframe.MouseButton2Click:Connect(function()
							textGuiLibrary["ObjectListEnabled"][i] = not textGuiLibrary["ObjectListEnabled"][i]
							textGuiLibrary["RefreshValues"](textGuiLibrary["ObjectList"])
						end))
						...
						deletebutton.Image = VLib.downloadAsset("vape/assets/AddRemoveIcon1.png")
						deletebutton.Position = UDim2.new(1, -16, 0, 14)
						deletebutton.Parent = itemframe
						VapeCleanup:append(deletebutton.MouseButton1Click:Connect(function()
                ...
                VapeCleanup:append(addbutton.MouseButton1Click:Connect(AddToList))
                VapeCleanup:append(textbox.FocusLost:Connect(function(enter)
                    if enter then
                        AddToList()
			...
			--[[windowapi3["CreateButton"] = function(argstable)
				...
				buttonimage.Image = VLib.downloadAsset(argstable["Icon"])
				...
				buttontexticon.Image = VLib.downloadAsset(argstable["Icon"])
			...
			VapeCleanup:append(drop1.MouseButton1Click:Connect(function()
			...
			VapeCleanup:append(drop1.MouseEnter:Connect(function()
				if not windowtitle.Visible then
					tweenService:Create(thing, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromRGB(107, 107, 107)}):Play()
				end
			end))
			VapeCleanup:append(drop1.MouseLeave:Connect(function()
				if not windowtitle.Visible then
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = VLib.downloadAsset("vape/assets/DownArrow.png")
			...
			VapeCleanup:append(drop1:GetPropertyChangedSignal("Text"):Connect(function()
				drop2.Text = drop1.Text
			end))
			drop2.ExpandButton2.Image = VLib.downloadAsset("vape/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
			...
			VapeCleanup:append(drop2.MouseButton1Click:Connect(function()
			...
			dropGuiLibrary["UpdateList"] = function(val)
				...
				for numbe, listobj in pairs(val) do
					...
					VapeCleanup:append(drop2.MouseEnter:Connect(function()
						drop2.BackgroundColor3 = Color3.fromRGB(31, 30, 31)
					end))
					VapeCleanup:append(drop2.MouseLeave:Connect(function()
						drop2.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
					end))
		...
		VapeCleanup:append(clickgui:GetPropertyChangedSignal("Visible"):Connect(windowapi["CheckVis"]))
		windowapi["CheckVis"]()
		...
		VapeCleanup:append(expandbutton.MouseButton1Click:Connect(windowapi["PinnedToggle"]))
		VapeCleanup:append(windowtitle.MouseButton2Click:Connect(windowapi["ExpandToggle"]))
		VapeCleanup:append(optionsbutton.MouseButton1Click:Connect(windowapi["ExpandToggle"]))
	...
	GuiLibrary["CreateWindow"] = function(argstablemain2)
		...
		windowicon.Image = VLib.downloadAsset(argstablemain2["Icon"])
		windowicon.Name = "WindowIcon"
		windowicon.BackgroundTransparency = 1
		windowicon.Position = UDim2.new(0, 12, 0, 12)
		windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = VLib.downloadAsset("vape/assets/UpArrow.png")
		...
		VapeCleanup:append(windowtitle.MouseButton2Click:Connect(windowapi["ExpandToggle"]))
		VapeCleanup:append(expandbutton.MouseButton1Click:Connect(windowapi["ExpandToggle"]))
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = VLib.downloadAsset("vape/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			if argstablemain["HoverText"] and type(argstablemain["HoverText"]) == "string" then
				...
				VapeCleanup:append(button.MouseMoved:Connect(function(x, y)
					hoverbox.Visible = (GuiLibrary["ToggleTooltips"] and hoverbox.TextSize ~= 1)
					hoverbox.Position = UDim2.new(0, (x + 16) * (1 / GuiLibrary["MainRescale"].Scale), 0,	(y - (hoverbox.Size.Y.Offset / 2) - 26) * (1 / GuiLibrary["MainRescale"].Scale))
				end))
			end
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = VLib.downloadAsset("vape/assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = VLib.downloadAsset("vape/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = VLib.downloadAsset("vape/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
			...
			buttonapi["CreateColorSlider"] = function(argstable)
				...
				VapeCleanup:append(slidersat.Slider.MouseButton1Down:Connect(function()
					slidercode(slidersat.Slider, "Sat")
				end))
				VapeCleanup:append(slidersat.Slider.ButtonSlider.MouseButton1Down:Connect(function()
					slidercode(slidersat.Slider, "Sat")
				end))
				VapeCleanup:append(sliderval.Slider.MouseButton1Down:Connect(function()
					slidercode(sliderval.Slider, "Value")
				end))
				VapeCleanup:append(sliderval.Slider.ButtonSlider.MouseButton1Down:Connect(function()
					slidercode(sliderval.Slider, "Value")
				end))
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = VLib.downloadAsset("vape/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = VLib.downloadAsset("vape/assets/SliderArrow1.png")
				...
				VapeCleanup:append(slider3:GetPropertyChangedSignal("Position"):Connect(function()
				...
				VapeCleanup:append(slider4:GetPropertyChangedSignal("Position"):Connect(function()
					slider2.Size = UDim2.new(0, slider4.AbsolutePosition.X - slider3.AbsolutePosition.X, 1, 0)
					slider2.Position = UDim2.new(slider3.Position.X.Scale, 0, 0, 0)
				end))
				...
				VapeCleanup:append(slider4.MouseButton1Down:Connect(function()
					local x,y,xscale,yscale,xscale2 = RelativeXY(slider1, inputService:GetMouseLocation())
			...
			VapeCleanup:append(bindbkg2.MouseButton1Click:Connect(function()
			...
			VapeCleanup:append(button.MouseButton2Click:Connect(buttonapi["ExpandToggle"]))
			VapeCleanup:append(button2.MouseButton1Click:Connect(buttonapi["ExpandToggle"]))
	...
	GuiLibrary["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = VLib.downloadAsset("vape/assets/SettingsWheel2.png")
		...
		VapeCleanup:append(settingsbutton.MouseButton1Click:Connect(function()
			if children.Visible then
				children.Visible = false
				children2.Visible = true
				windowtitle.Size = UDim2.new(0, 220, 0, 45 + uilistlayout2.AbsoluteContentSize.Y)
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, textService:GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = VLib.downloadAsset("vape/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			VapeCleanup:append(sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = VLib.downloadAsset("vape/assets/HoverArrow2.png")
			end))
			VapeCleanup:append(sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = VLib.downloadAsset("vape/assets/HoverArrow.png")
			end))
	...
	GuiLibrary["CreateLegitModule"] = function(legittable)
		...
		VapeCleanup:append(legitframe.MouseButton1Click:Connect(function() legitapi["ToggleButton"](not legitapi["Enabled"], false) end))
	...
	local function bettertween(obj, newpos, dir, style, tim, override)
		task.spawn(function()
			...
			local tweenConnection = VapeCleanup:append(frame:GetPropertyChangedSignal("Position"):Connect(function()
	...
	VapeCleanup:append(notificationwindow.ChildRemoved:Connect(function()
	...
	GuiLibrary["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = VLib.downloadAsset("vape/assets/NotificationBackground.png")
		...
		frame2.Name = "Frame"
		local NotifConnection = VapeCleanup:append(frame2:GetPropertyChangedSignal("BackgroundColor3"):Connect(function()
		...
		frame2.ZIndex = 2
		frame2.Image = VLib.downloadAsset("vape/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = VLib.downloadAsset(customicon and "vape/"..customicon or "vape/assets/InfoNotification.png")
	...
	GuiLibrary["KeyInputHandler2"] = VapeCleanup:append(inputService.InputEnded:Connect(function(input1)
		if input1.KeyCode == Enum.KeyCode.RightAlt then
			holdingalt = false
		end
	end))

	VapeCleanup:append(searchbar:GetPropertyChangedSignal("Text"):Connect(function()
		...
		if searchbar.Text == "" then
			...
			for i,v in pairs(GuiLibrary.ObjectsThatCanBeSaved) do
				if i:find("OptionsButton") and i:sub(1, searchbar.Text:len()):lower() == searchbar.Text:lower() then
					...
					VapeCleanup:append(v.Object:GetPropertyChangedSignal("BackgroundColor3"):Connect(function()
						button.BackgroundColor3 = v.Object.BackgroundColor3
					end))
					local buttonactiveborder = Instance.new("Frame")
					buttonactiveborder.BackgroundTransparency = 0.75
					...
					button2.Parent = button
					VapeCleanup:append(v.Object.OptionsButton:GetPropertyChangedSignal("Image"):Connect(function()
						button2.Image = v.Object.OptionsButton.Image
					end))
					local buttontext = Instance.new("TextLabel")
					buttontext.BackgroundTransparency = 1
					...
					VapeCleanup:append(v.Object.ButtonText:GetPropertyChangedSignal("TextColor3"):Connect(function()
						buttontext.TextColor3 = v.Object.ButtonText.TextColor3
					end))
					buttontext.TextSize = 17
					buttontext.Font = Enum.Font.SourceSans
	...
	VapeCleanup:append(searchbaricon2.MouseButton1Click:Connect(function()
